...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <ASIDE class="aside_right">
    <A href="./create.do?newsgrp_no=${param.newsgrp_no}">글 등록</A>
    <c:choose>
    ...
    <span class='menu_divide' > | </span>
    <A href='../news_attachfile/create.do?newsgrp_no=${newsgrp_no }&news_no=${news_no }'>파일 등록</A>
    <span class='menu_divide' > | </span>
      ...
      <fieldset class="fieldset">
        <ul>
          <li class="li_none" style='border-bottom: solid 1px #AAAAAA;'>
            <span> 제목 : ${newsVO.news_head}</span><br>
            <span> 등록일 : ${newsVO.news_date.substring(0, 16)}</span><br>
            <span> 조회수 : ${newsVO.news_count}</span>
          </li>
          <li class="li_none">
